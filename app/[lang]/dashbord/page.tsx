  ...
  return (
    <div className="bg-background font-body-md text-on-surface">
      ...
      <main className="max-w-[1440px] mx-auto flex min-h-screen">
        ...
        <section className="flex-1 p-10 bg-slate-50/30">
          <header className="mb-10">
            <h2 className="font-headline-lg text-3xl mb-2">Bonjour, Aminata</h2>
            <p className="text-slate-500">Bienvenue dans votre espace privilégié Jeune & Jolie.</p>
          </header>
