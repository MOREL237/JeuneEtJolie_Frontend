    ...
    <section ref={sectionRef} className="py-20 md:py-28 bg-surface-container-low">
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-20">
        ...
        <div className="reveal mb-12 md:mb-16" data-reveal="">
          <div className="section-eyebrow mb-3">{t('featured.eyebrow')}</div>
          <h2
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-stretch">
              ...
              <div className="relative h-full min-h-[420px]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 md:p-10">
                  ...
                  <button className="btn-gold">
                    {t('featured.exploreSelection')} <ArrowRight size={14} className="inline ml-1" />
                  </button>
                </div>
              </div>
            </TiltCard>
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              ...
              >
                {t('featured.viewCollection')} <ArrowRight size={13} />
              </a>
            </div>
